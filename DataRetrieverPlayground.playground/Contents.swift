...
//let reportPeriod = TwoPartTimeReportPeriod(scope: Period(start: start, end: end),
//                                           previousToDayOfRequest: Period(start: start, end: yesterday),
//                                           dayOfRequest: Period(start: today, end: today))
//
