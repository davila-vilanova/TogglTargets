...
class TimePeriodPreferencesViewController: NSViewController, BindingTargetProvider {
    ...
    private lazy var updatedPreference: Signal<PeriodPreference, Never> =
    ...
    private lazy var generateWeeklyPeriodPreference =
        Action<Weekday, PeriodPreference, Never> (enabledIf: isWeeklyPreferenceSelectedProperty,
    ...
    private func reflectCurrentPeriod() {
        ...
        let formatter: SignalProducer<DateFormatter, Never> = {
        ...
        func formattedDayComponents(_ dayComponents: SignalProducer<DayComponents, Never>)
...
private func weekdayToWeeklyPeriodPreferenceProducer(_ weekday: Weekday)
    -> SignalProducer<PeriodPreference, Never> {
